...
public class BindUIServiceActivity extends AppCompatActivity implements View.OnClickListener

{private static final String TAG = BindUIServiceActivity.class.getSimpleName();
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_ui_bind);
            ...
            serviceIntent=new Intent(getApplicationContext(),BindService.class);
            ...
            if(serviceConnection==null){
                serviceConnection=new ServiceConnection() {
                    ...
                    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                        BindService.MyServiceBinder myServiceBinder=(BindService.MyServiceBinder)iBinder;
